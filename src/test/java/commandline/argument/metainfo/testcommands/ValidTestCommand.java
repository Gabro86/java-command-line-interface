...
public class ValidTestCommand {
	...
	@CommandArgument(shortName = COMMAND_1_SHORT_NAME, longName = COMMAND_1_LONG_NAME, obligatory = true,
	...
	@SuppressWarnings("UnusedParameters")
	@CommandArgument(shortName = COMMAND_2_SHORT_NAME, longName = COMMAND_2_LONG_NAME, obligatory = true,
	...
	@SuppressWarnings("UnusedParameters")
	@CommandArgument(shortName = COMMAND_3_SHORT_NAME, longName = COMMAND_3_LONG_NAME, obligatory = true,
	...
	@SuppressWarnings("UnusedParameters")
	@CommandArgument(shortName = COMMAND_4_SHORT_NAME, longName = COMMAND_4_LONG_NAME, obligatory = false,
	...
	@SuppressWarnings("UnusedParameters")
	@CommandArgument(shortName = COMMAND_5_SHORT_NAME, longName = COMMAND_5_LONG_NAME, obligatory = false,
			defaultToNull = true, parser = StringArgumentParser.class, validator = DefaultArgumentValidator.class,
			description = DESCRIPTION, examples = {EXAMPLE})
